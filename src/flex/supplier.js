...
const Suppliers = () => { // const navigate = useNavigate()
    return (
        <>
            <div className="main">
                <Header/>
                <div className="info-cl">
                    <h2 className="bg-2">Suppliers</h2>
                    <div className="each-card">

                        <div className="card">
                            <div className="data-c">
                                <span className="small-c">Total Suppliers</span>
                        ...
                        <div className="card">
                            <div className="data-c">
                                <span className="small-c">Newer  Suppliers</span>
                        ...
                        <div className="card">
                            <div className="data-c">
                                <span className="small-c">Active Suppliers</span>
                    ...
                    <div className="lg-card">
                        <div className="lg-title">
                            <div className="mtc-cl2">
                                <div className="mtc-cl">Supplier's Account</div>
                                <span style={
                                    {
                                        color: '#475467',
                                        fontSize: '14px',
