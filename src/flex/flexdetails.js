...
import user from "../assets/images/dea.svg";
...
import axios from "axios";
import factoring from "../assets/images/orderlogo.svg";
...
const FlexDetails = () => {
  ...
  */
  ...
  useEffect(() => {
    const getPartnerOrder = async () => {
      await axios
        .get(`/v1/admin/flex/get-all-orders?flexUser=${state._id}`)
        .then((res) => {
        settransaction(res.data.data);
        })
        .catch((e) => {
 ...
 // console.log(transaction)
  ...
  return (
    <>
      ...
      >
        <OtherHeader title={"BACK TO FLEX"} arrow={"keyboard_backspace"} />
        ...
        <div className="info-cl">
          <div className="overview">
            ...
            >
              {state?.customtype === 'Partner' ? 'Network' : state?.customtype } Details
            </h4>
          </div>
            ...
            >
              ...
              <div className="top_head_cl" style={{ padding: "24px" }}>
                ...
                <div
                  ...
                  style={{
                    color: businessstatus === "ACTIVE" && "#12B76A",
                  }}
                >
                  {businessstatus}
                </div>
                ...
                <div className="md-details-col">
                  ...
                  >
                    <div className="each_main_tl">
                      ...
                      <span className="d-lt-a">{state?.businessName}</span>
                    </div>
                    <div className="each_main_tl">
                      <div className="each_d_lt">Address</div>
                      <span className="d-lt-a">{state?.business?.address}</span>
                    </div>
                  ...
                  >
{
  !state.isAdminCreated  && <>
                    ...
                    <div className="each_main_tl">
                      <div className="each_d_lt">Owner</div>
                      <span className="d-lt-a">
                        {state?.business?.user?.firstName} {state?.business?.user?.lastName}{" "}
                      </span>
                    </div>
                    <div className="each_main_tl">
                      <div className="each_d_lt">Email address</div>
                      <span className="d-lt-a">{state?.business?.user?.email}</span>
                    </div>
                    <div className="each_main_tl">
                      <div className="each_d_lt">Phone Number</div>
                      <span className="d-lt-a">{state.business?.user?.phoneNumber}</span>
                    </div>
                    <div className="each_main_tl">
                      <div className="each_d_lt">Added By</div>
                      <span className="d-lt-a">{state.business?.name}</span>
                    </div>
...
}
{
  state.isAdminCreated  && <>
                    ...
                    {/** 
                    <div className="each_main_tl">
                      <div className="each_d_lt"></div>
                      <span className="d-lt-a">{state.receiverBusiness?.address}</span>
                    </div>
                    <div className="each_main_tl">
                    ...
                    <div className="each_main_tl">
                      ...
                      <span className="d-lt-a">
                        {state?.receiverBusiness?.user?.firstName} {state?.receiverBusiness?.user?.lastName}{" "}
                      </span>
                    </div>

                    <div className="each_main_tl">
                      <div className="each_d_lt">Type</div>
                      <span className="d-lt-a">{state.flexUserType} </span>
                    </div>
                    */}
                    </>
}
