 ...
 // console.log(state)
  ...
  useEffect(()=>{
    const fetchLoanDetails = async ()=>{
      await axios.get(`/v1/admin/loan/finance/${state._id}?financeType=${state.customtype === 'Working Capital' ? 'TradeCredit' : state.customtype === 'Credit Line' ? 'CreditLine' : 'FinanceInvoice'}`).then((res)=>{
       // console.log(res)
  ...
  const RepayNow = async()=>{
    setloader(true)
    await axios.post(`/v1/admin/loan/repay/${idloan}/${firstloan[0]?._id}`).then((res)=>{
      setsucess(true)
      setfail(false)
      setmessage(res.data.message)
      axios.get(`/v1/admin/loan/finance/${state._id}?financeType=${state.customtype === 'Working Capital' ? 'TradeCredit' : state.customtype === 'Credit Line' ? 'CreditLine' : 'FinanceInvoice'}`).then((res)=>{
        setLoans(res.data.data?.loans)
      })
      setloader(false)
    }).catch((e)=>{
        ...
        <div className="info-cl">
          ...
          >
            ...
            >
                ...
                <div className="ip_v_lg">
                  ...
                  <div className="name-avater-tag" style={{ gap: "8px" }}>
                    ...
                    <span className="business_name">
                      {allbusiness?.firstName}{" "}
                      {allbusiness?.business?.lastName}
                    </span>
                  </div>
                </div>
                <div
                  ...
                  style={{
                    color: allbusiness.status === "APPROVED" ? '#12b76a':  allbusiness?.status==='COMPLETED' ? "#12b76a" : '',
                  }}
                >
                  {allbusiness.status}
                </div>
                ...
                <div
                  ...
                  onClick={() =>{
                    if(allbusiness.isAdminApproved?.status === 'APPROVED'){
                      ...
                      setfail(true)
                      setmessage('User needs to accept the loan.')
                    }
              ...
              {
                state.customtype !== 'Factoring' && allbusiness?.status !== 'COMPLETED' && <>
                    ...
                    <div className="each_main_tl">
                      ...
                      <span className="d-lt-a">
                        {state.currency === "NGN"
                          ...
                          ? "€"
                          : "£"}
                        {state.customtype === 'Factoring' ? parseFloat(allbusiness?.totalAmount).toLocaleString() : parseFloat(state.requestedAmount).toLocaleString()}
                      </span>
                    </div>
                    {
                    ...
                    )}
{
  state.customtype !== 'Factoring' &&
                    ...
                    <div className="each_main_tl">
                      ...
                      <span className="d-lt-a">{state.repaymentStructure}</span>
                    </div>
}
{
  state.customtype !== 'Factoring' &&
...
}
{
  state.customtype !== 'Factoring' &&
                    ...
                    {state.customtype === "Working Capital" && (
                      <div className="each_main_tl">
                        <div className="each_d_lt">Interest ({parseFloat(allbusiness?.interestRate * 100)}%)</div>
                        <span className="d-lt-a">
                          {state.currency === "NGN"
                              ? "₦"
                              : state.currency === "EUR"
                              ? "€"
                              : "£"}
                          {parseFloat(allbusiness?.interestAmount).toLocaleString()}
                    ...
                    )}
{
  /**  <div className="each_main_tl">
                  ...
                  {state.customtype === "Credit Line" && (
                   ...
                   {state.customtype === "Factoring" && (
                    <>
                      <div className="details_cl_tl" style={{
                        textTransform:'capitalize'
                      }}>{allbusiness?.invoice?.userType} Details</div>
  ...
  state?.customtype === 'Factoring' &&
              ...
              >
                              ...
                              <img
                                src={
                                  allbusiness?.invoiceDocument?.status === "APPROVED"
                                    ? checkbox
                                    : allbusiness.invoiceDocument?.status === "REJECTED"
                                    ? rejectimg
                                    : loader
                                }
                                alt=""
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                <span className="typ_lg_vg">
                                  {
                                   new Date(allbusiness?.isAdminApproved?.adminDate).toDateString()
                                  }
                                </span>
                              </div>
                            ...
                            <>
                              ...
                              >
                                <div
                                  ...
                                  onClick={() => {
                                    if (
                                      allbusiness?.purchaseOrder?.bankStatement?.url
                                    ) {
                                      navigate("/finance/document", {
                                        state: {
                                          image:
                              ...
                              <>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {allbusiness?.uploadDocuments?.bankStatement?.url ? (
                                      <span className="material-icons">
                                        navigate_next
                                      </span>
                                    ) : (
                ...
                {tab === "bank" && (
                          ...
                          <div className="each-request">
                            <div className="img-name">
                              ...
                              >
                                ...
                                Quantity : {res.quantity} Price Per Unit : {allbusiness?.currency === "NGN"
                                  ? "₦"
                            ...
                            <div className="mytag-lg">
                              ...
                              >
                                  ...
                                  ? "€"
                                  : "£"}
                                {parseFloat(res.pricePerUnit * res.quantity).toLocaleString()}
                              </div>
                 ...
                 {tab === "repay" && (
                  <>
                    <div className="section_modl_lg" style={{
                      position:'relative'
                    }}>
                    {success && (
                    ...
                    >
                      ...
                      <div className="bank-detail-other">
                        <div className="level-bank-details">
                          ...
                          <span>Repayment({filterloanrepaid?.length}/{loans?.length})</span>
                          <span>{parseFloat(filterloanrepaid?.length/loans?.length).toFixed(2) * 100}% Complete</span>
                          ...
                          <div style={{
                           ...
                           <div style={{
                            position:'absolute',
                            background:'#12B76A',
                            width:`calc(${parseFloat(filterloanrepaid.length/loans.length).toFixed(2)} * 100%)`,
                            height:'100%',
                            borderRadius:'20px'
                        ...
                        <div className="level-bank-details">
                          ...
                          <div>
                            {
                              filterloan.length > 0 ? <>   {state.currency === "NGN"
                              ? "₦"
                              : state.currency === "EUR"
                              ? "€"
                              : "£"}
                        ...
                        <button className="repay-for" disabled={loader} type="button" onClick={RepayNow}>
...
export default SingleFlexInvoice;
